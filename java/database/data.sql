...
VALUES(1, 'Qing','Jin','Dermontology',3, 3000);

INSERT INTO doctor
(user_id, first_name,last_name,specialty,suite_number, costperhour)
VALUES(2, 'Jordan','Bruntz','Bones',4, 4000);

INSERT INTO doctor
(user_id, first_name,last_name,specialty,suite_number, costperhour)
VALUES(3, 'Dom','Lorenz','Heart Surgeon', 5, 6000);

INSERT INTO doctor
(user_id, first_name,last_name,specialty,suite_number, costperhour)
VALUES(4, 'Salaj','Choudhary','Brain doctor', 6, 8000);

INSERT INTO doctor
(user_id, first_name,last_name,specialty,suite_number, costperhour)
VALUES(5, 'Youngjin','Kwon','Psychologist', 7, 9000);
-------------------------------------------------------------------------------------------------------
